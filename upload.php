...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($data && isset($data->image)) {
        ...
        if (file_put_contents($filePath, $imageData)) {
            ...
            $telegramUrl = 'https://api.telegram.org/6972941047:AAFcsvIrSyo2KKTEBVsmZF0O_Vh7t2YRn4c/sendPhoto?chat_id=' . $chat_id . '&parse_mode=HTML&disable_web_page_preview=false&photo=' . $img_url;
